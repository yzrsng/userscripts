// ==UserScript==
// @name           Global Dark Inverted Dynamic Restyle Script
// @name:ja        Global Dark Inverted Dynamic Restyle Script
...
// @author         yzrsng
// @downloadURL    https://raw.githubusercontent.com/yzrsng/userscripts/master/dynamic-restyle-for-global-dark-inverted.js
// @include        http://*
// @include        https://*
// @match          *://*
...
[${dataOriginFilters}] {
    ...
    filter: var(${cssVariableOriginFilters}, invert(0)) drop-shadow(0px 0px 1px var(${cssVariableFilterColor}, #80808080)) !important;
        ...
        const returnNewFrontColorAry = (oldRgbAry) => {
            ...
            const invertedRgb = hslToRgb(newHslAry);
            for (let i = 0; i < 3; i++) {
                invertedRgb[i] = 255 - invertedRgb[i];
            }
            return invertedRgb;
